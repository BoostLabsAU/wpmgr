...
import { getFeature, FEATURE_SLUGS } from "@/lib/content/features";
...
export default async function FeatureOgImage({ params }: Props) {
  ...
  const title = feature.hero.heading;
  const tagline = feature.hero.subhead;
  const eyebrow = feature.hero.eyebrow;
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span style={{ fontSize: "16px", color: COLORS.muted }}>wpmgr.app/features</span>
