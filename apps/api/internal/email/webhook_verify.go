...
func snsSignatureMessage(msg snsMessage) string {
	...
	switch msg.Type {
	case "Notification":
		b.WriteString("Message\n"); b.WriteString(msg.Message); b.WriteString("\n")
		b.WriteString("MessageId\n"); b.WriteString(msg.MessageID); b.WriteString("\n")
		if msg.Subject != "" {
			b.WriteString("Subject\n"); b.WriteString(msg.Subject); b.WriteString("\n")
		}
		b.WriteString("Timestamp\n"); b.WriteString(msg.Timestamp); b.WriteString("\n")
		b.WriteString("TopicArn\n"); b.WriteString(msg.TopicArn); b.WriteString("\n")
		b.WriteString("Type\n"); b.WriteString(msg.Type); b.WriteString("\n")
	case "SubscriptionConfirmation", "UnsubscribeConfirmation":
		b.WriteString("Message\n"); b.WriteString(msg.Message); b.WriteString("\n")
		b.WriteString("MessageId\n"); b.WriteString(msg.MessageID); b.WriteString("\n")
		b.WriteString("SubscribeURL\n"); b.WriteString(msg.SubscribeURL); b.WriteString("\n")
		b.WriteString("Timestamp\n"); b.WriteString(msg.Timestamp); b.WriteString("\n")
		b.WriteString("Token\n"); b.WriteString(msg.Token); b.WriteString("\n")
		b.WriteString("TopicArn\n"); b.WriteString(msg.TopicArn); b.WriteString("\n")
		b.WriteString("Type\n"); b.WriteString(msg.Type); b.WriteString("\n")
	}
	return b.String()
